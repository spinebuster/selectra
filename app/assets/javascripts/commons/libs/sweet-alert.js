...
(function(window, document) {
  ...
  window.sweetAlertInitialize = function() {
    var sweetHTML = '<div class="sweet-overlay" tabIndex="-1"></div><div class="sweet-alert" tabIndex="-1"><div class="icon error"><span class="x-mark"><span class="line left"></span><span class="line right"></span></span></div><div class="icon warning"> <span class="body"></span> <span class="dot"></span> </div> <div class="icon info"></div> <div class="icon success"> <span class="line tip"></span> <span class="line long"></span> <div class="placeholder"></div> <div class="fix"></div> </div> <div class="icon custom"></div> <h2 class="h2-sweet-alert">Title</h2><p class="lead-sweet-alert text-muted">Text</p><p><button class="cancel btn btn-sweet-alert" tabIndex="2">Cancel</button> <button class="confirm btn btn-sweet-alert" tabIndex="1">OK</button></p></div>',
  ...
  function setParameters(params) {
    ...
    $confirmBtn.className = 'confirm btn btn-sweet-alert'
